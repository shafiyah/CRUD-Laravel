    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div>
          <table class="table table-bordered" id="dynamicTable">  
            ...
            <tr>  
                <td><input type="text" name="addmorerelasi[]" placeholder="relasi" class="form-control" /></td> 
                <td><input type="text" name="addmorename[]" placeholder="Masukan Nama" class="form-control" /></td>  
                <td><input type="date" name="addmoredob[]" placeholder="Pilih Tanggal" class="form-control" /></td>  
